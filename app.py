...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:password@localhost/breast_cancer_db'
...
def train_model():
    ...
    flash('Model training should be done separately. Please run train.py from the backend directory.', 'info')
    return redirect(url_for('dashboard'))
